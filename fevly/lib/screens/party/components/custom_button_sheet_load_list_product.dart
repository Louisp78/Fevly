...
class CustomBottomSheetLoadListProduct extends StatelessWidget {
  const CustomBottomSheetLoadListProduct({
    Key? key,
    required this.title,
  }) : super(key: key);
                  ...
                  press: () {
                    if (textFieldProvider.value!.name != "Aucune") {
                      productListListForDropdown.add(ProductList(
                          listOfProduct: textFieldProvider.value!.listOfProduct,
