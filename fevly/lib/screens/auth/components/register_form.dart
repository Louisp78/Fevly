      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            hintStyle: textTheme.bodyText1!.copyWith(color: themeColor.surface),
            ...
            suffix: buildPseudoSuffixIcon(state: pseudoState, context: context),
          ...
          Align(
            ...
            child: SizedBox(
              ...
              child: CustomLoadingButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate() &&
                    ...
                    await appState.registerAccount(
                      ...
                      onPseudoAlreadyExists: () => setState(() {
                        pseudoErrorMsg = "Ce pseudo existe déjà";
                      }),
                ...
                text_not_loading: "Accepter les conditions d'utilisations",
