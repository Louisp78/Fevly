...
void main(List<String> args) {
  group("User Basics", () {
    test("Instanciate", () {
      var user = CurrentUserInfos(
          name: "Loulou", pseudo: "llouisp78", password: "123456799");
      expect(user.toString(),
          "User(name: Loulou, login: llouisp, password: 123456799)");
    });
    group("User relations", () {
      var user1 = CurrentUserInfos(
          name: "Loulou", pseudo: "llouisp", password: "123456799");
      var user2 = CurrentUserInfos(
        name: "Loulou",
        pseudo: "llouisp",
        password: "123456799",
      );
